  ...
  return (
    <Card className="user-details-card" style={{ width: '22rem', margin: '20px' }}>
      <Card.Body>
        ...
        <Card.Img variant="top" src={userDetails.image} alt={userDetails.userName} style={{ height: '400px', borderBottom: '5px solid black' }} />
        ...
        <div className="d-flex flex-column align-items-center justify-content-center">
          {/* <Link href={`/user/${userDetails.firebaseId}`} passHref>
